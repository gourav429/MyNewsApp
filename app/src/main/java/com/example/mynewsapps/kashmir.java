...
public class kashmir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://www.google.com/search?client=firefox-b-d&q=kashmir+tourism");
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.about:
                ...
                Intent in1 = new Intent(kashmir.this,About.class);
                startActivity(in1);
                finish();
                return true;
            case R.id.logout:
                Intent in2 = new Intent(kashmir.this,Login.class);
                startActivity(in2);
                finish();
                return true;
            default:
