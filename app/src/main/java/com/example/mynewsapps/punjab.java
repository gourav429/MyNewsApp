...
public class punjab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://www.google.com/search?client=firefox-b-d&q=punjab+tourism");
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.about:
                ...
                Intent in1 = new Intent(punjab.this,About.class);
                startActivity(in1);
                finish();
                return true;
            case R.id.logout:
                Intent in2 = new Intent(punjab.this,Login.class);
                startActivity(in2);
                finish();
                return true;
            default:
